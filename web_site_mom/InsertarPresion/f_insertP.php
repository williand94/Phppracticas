...
<body>
    ...
    <div class="form">
        ...
        <form action="insert_presion.php" method="get">
        ...
        <tr><td>Medicamento</td><td><input type="text" name="mcd" id="mcd"></td></tr>
        <tr><td><input type="submit" name="mcd" id="mcd" value="Enviar!"></td></tr>
